...
<h3>Parent, Adult, and Youth Participant Surveys -- Aggregate Results</h3>
<p align="center">    
...
<!--        <a href="">Reset Aggregates</a>-->
    ...
    include "../include/dbconnopen.php";
    $get_pre_averages = mysqli_query($cnnBickerdike, "CALL get_full_aggregate_survey_results(1)");
    $pre = array();
    ...
    include "../include/dbconnclose.php";
    include "../include/dbconnopen.php";
    $get_post_averages = mysqli_query($cnnBickerdike, "CALL get_full_aggregate_survey_results(2)");
    $post = array();
    ...
    include "../include/dbconnopen.php";
    $get_later_averages = mysqli_query($cnnBickerdike, "CALL get_full_aggregate_survey_results(3)");
    $later = array();
