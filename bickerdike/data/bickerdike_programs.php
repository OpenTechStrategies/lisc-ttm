...
<div id="bickerdike_stats"><ul>
    <li>Number of participating organizations: <strong><?
        $count_partners_sqlsafe = "SELECT * FROM `lisc-bickerdike.chapinhall.org`.Org_Partners;";
...
<table class="all_projects" style="width:300px;">
    ...
    $get_trail_info_sqlsafe = "SELECT * FROM `lisc-bickerdike.chapinhall.org`.Bike_Trails";
    include "../include/dbconnopen.php";
