...
<div class="content_wide" id="participant_survey_data">
    ...
    <table class="all_projects">
        ...
        $count_pres_sqlsafe = "CALL get_full_aggregate_individual_survey_results_pre_post_count(1)";
        include "../include/dbconnopen.php";
        $pres = mysqli_query($cnnBickerdike, $count_pres_sqlsafe);
        $num_pres = mysqli_num_rows($pres);
        include "../include/dbconnclose.php";

        $count_posts_sqlsafe = "CALL get_full_aggregate_individual_survey_results_pre_post_count(2)";
        include "../include/dbconnopen.php";
...
<div class="content_wide" id="participant_survey_data">
    ...
    <table class="all_projects">
        ...
        <?php
        //count the number of surveys entered that have all steps
        $count_pres_sqlsafe = "CALL get_full_aggregate_individual_survey_results_count(1)";
        include "../include/dbconnopen.php";
        $pres = mysqli_query($cnnBickerdike, $count_pres_sqlsafe);
        $num_pres = mysqli_num_rows($pres);
        include "../include/dbconnclose.php";

        $count_posts_sqlsafe = "CALL get_full_aggregate_individual_survey_results_count(2)";
        include "../include/dbconnopen.php";
        $posts = mysqli_query($cnnBickerdike, $count_posts_sqlsafe);
        $num_posts = mysqli_num_rows($posts);
        include "../include/dbconnclose.php";

        $count_laters_sqlsafe = "CALL get_full_aggregate_individual_survey_results_count(3)";
        include "../include/dbconnopen.php";
        $laters = mysqli_query($cnnBickerdike, $count_laters_sqlsafe);
        $num_laters = mysqli_num_rows($laters);
        include "../include/dbconnclose.php";
