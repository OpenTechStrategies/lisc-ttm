...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#total_selector').addClass('selected');
        $('#data_selector').addClass('selected');
    });
</script>

<div class="content_wide" id="participant_survey_data">
    <h3>Parent, Adult, and Youth Participant Surveys -- Individual Aggregate Results<br />
    Completed Pre And Post</h3>
    <p align="center">    
    ...
    <table class="all_projects">
        ...
        <?php
        //count the number of surveys entered that have all steps
        $count_pres = "CALL get_full_aggregate_individual_survey_results_pre_post_count(1)";
        include "../include/dbconnopen.php";
        $pres = mysqli_query($cnnBickerdike, $count_pres);
        $num_pres = mysqli_num_rows($pres);
        include "../include/dbconnclose.php";

        $count_posts = "CALL get_full_aggregate_individual_survey_results_pre_post_count(2)";
        include "../include/dbconnopen.php";
        ...
        <tr>
            ...
            <th>Pre-Survey<br>(<?php echo $num_pres ?> surveys)</th>
            <th>Post-Survey<br>(<?php echo $num_posts ?> surveys)</th>
            <th>Three Months Later<br>(<?php echo $num_laters ?> surveys)</th>
        </tr>
        <?php
        ...
        include "../include/dbconnopen.php";
        $get_pre_averages = mysqli_query($cnnBickerdike, "CALL get_full_aggregate_individual_survey_results_pre_post(1)");
        $pre = array();
        ...
        include "../include/dbconnclose.php";
        include "../include/dbconnopen.php";
        $get_post_averages = mysqli_query($cnnBickerdike, "CALL get_full_aggregate_individual_survey_results_pre_post(2)");
        $post = array();
        ...
        include "../include/dbconnopen.php";
        $get_later_averages = mysqli_query($cnnBickerdike, "SELECT AVG(Question_2), AVG(Question_3), 
                                                            ...
                                                            AVG(Question_14)
                                                            FROM Participant_Survey_Responses WHERE Pre_Post_Late='3'");
        $later = array();
        ...
        <tr>
            ...
            <td class="all_projects"><?php echo $pre[0] ?></td>
            <td class="all_projects"><?php echo $post[0]; ?></td>
            <td class="all_projects"><?php echo $later[0]; ?></td>
        </tr>
        <tr>
            ...
            <td class="all_projects"><?php echo $pre[1] ?></td>
            <td class="all_projects"><?php echo $post[1]; ?></td>
            <td class="all_projects"><?php echo $later[1]; ?></td>
        </tr>
        <tr>
            ...
            <td class="all_projects"><?php echo $pre[2] ?></td>
            <td class="all_projects"><?php echo $post[2]; ?></td>
            <td class="all_projects"><?php echo $later[2]; ?></td>
        </tr>
        <tr>
            <td class="all_projects" style="text-align:left;">Question 3b: How many minutes on those days?</td>
            <td class="all_projects"><?php echo $pre[3] ?></td>
            <td class="all_projects"><?php echo $post[3]; ?></td>
            <td class="all_projects"><?php echo $later[3]; ?></td>
        </tr>
        <tr>
            ...
            <td class="all_projects"><?php echo $pre[4] ?></td>
            <td class="all_projects"><?php echo $post[4]; ?></td>
            <td class="all_projects"><?php echo $later[4]; ?></td>
        </tr>
        <tr>
            <td class="all_projects" style="text-align:left;">Question 4b: How many minutes on those moderate activity days?</td>
            <td class="all_projects"><?php echo $pre[5] ?></td>
            <td class="all_projects"><?php echo $post[5]; ?></td>
            <td class="all_projects"><?php echo $later[5]; ?></td>
        </tr>
        <tr>
            ...
            <td class="all_projects"><?php echo $pre[7] ?></td>
            <td class="all_projects"><?php echo $post[7]; ?></td>
            <td class="all_projects"><?php echo $later[7]; ?></td>
        </tr>
        <tr>
            ...
            <td class="all_projects"><?php echo $pre[8] ?></td>
            <td class="all_projects"><?php echo $post[8]; ?></td>
            <td class="all_projects"><?php echo $later[8]; ?></td>
        </tr>
        <tr>
            ...
            <td class="all_projects"><?php echo $pre[10] ?></td>
            <td class="all_projects"><?php echo $post[10]; ?></td>
            <td class="all_projects"><?php echo $later[10]; ?></td>
        </tr>
        <tr>
            ...
            <td class="all_projects"><?php echo $pre[9] ?></td>
            <td class="all_projects"><?php echo $post[9]; ?></td>
            <td class="all_projects"><?php echo $later[9]; ?></td>
        </tr>
        ...
        <tr>
            ...
            <td class="all_projects"><?php echo $pre[11] ?></td>
            <td class="all_projects"><?php echo $post[11]; ?></td>
            <td class="all_projects"><?php echo $later[11]; ?></td>
        </tr>
        <tr>
            ...
            <td class="all_projects"><?php echo $pre[12] ?></td>
            <td class="all_projects"><?php echo $post[12]; ?></td>
            <td class="all_projects"><?php echo $later[12]; ?></td>
        </tr>
        <tr>
            ...
            <td class="all_projects"><?php echo $pre[13] ?></td>
            <td class="all_projects"><?php echo $post[13]; ?></td>
            <td class="all_projects"><?php echo $later[13]; ?></td>
        </tr>
        <tr>
            ...
            <td class="all_projects"><?php echo $pre[14] ?></td>
            <td class="all_projects"><?php echo $post[14]; ?></td>
            <td class="all_projects"><?php echo $later[14]; ?></td>
        </tr>
        <!---Now, create the file for download. -->

        <tr>
<?php
$infile = "downloads/survey_aggregate_individual_pre_post.csv";
...
fclose($fp);
?>
            <td class="all_projects" colspan="4">    <a href="<?php echo $infile; ?>">Download the CSV file of aggregate survey results.</a></td> 
...
<div class="content_wide" id="participant_survey_data">
    <h3>Parent, Adult, and Youth Participant Surveys -- Individual Aggregate Results<br />
    Completed Pre, Post, And Three-Month Follow-Up</h3>
    <p align="center">    
        <!--Sort surveys by date.  Sends them off to surveys_sorted_by_dates.php, but only 
        returns the table of averages, no line/pie charts.-->
        <?php include "../include/datepicker.php"; ?>
    ...
    <table class="all_projects">
        ...
        <?php
        //count the number of surveys entered that have all steps
        $count_pres = "CALL get_full_aggregate_individual_survey_results_count(1)";
        include "../include/dbconnopen.php";
        $pres = mysqli_query($cnnBickerdike, $count_pres);
        $num_pres = mysqli_num_rows($pres);
        include "../include/dbconnclose.php";

        $count_posts = "CALL get_full_aggregate_individual_survey_results_count(2)";
        include "../include/dbconnopen.php";
        $posts = mysqli_query($cnnBickerdike, $count_posts);
        $num_posts = mysqli_num_rows($posts);
        include "../include/dbconnclose.php";

        $count_laters = "CALL get_full_aggregate_individual_survey_results_count(3)";
        include "../include/dbconnopen.php";
        $laters = mysqli_query($cnnBickerdike, $count_laters);
        $num_laters = mysqli_num_rows($laters);
        include "../include/dbconnclose.php";
        ...
        /* the routine gets the average response for each question, as you can see.
          ...
          mysqli_fetch_array works.  Sigh. */
        include "../include/dbconnopen.php";
        $get_pre_averages = mysqli_query($cnnBickerdike, "CALL get_full_aggregate_individual_survey_results(1)");
        $pre = array();
        while ($pre_averages = mysqli_fetch_array($get_pre_averages)) {
            $pre[0] = $pre_averages['AVG(Question_2)'];
            $pre[1] = $pre_averages['AVG(Question_3)'];
        ...
        include "../include/dbconnclose.php";
        include "../include/dbconnopen.php";
        $get_post_averages = mysqli_query($cnnBickerdike, "CALL get_full_aggregate_individual_survey_results(2)");
        $post = array();
        while ($post_averages = mysqli_fetch_array($get_post_averages)) {
            $post[0] = $post_averages['AVG(Question_2)'];
            $post[1] = $post_averages['AVG(Question_3)'];
        ...
        include "../include/dbconnopen.php";
        $get_later_averages = mysqli_query($cnnBickerdike, "CALL get_full_aggregate_individual_survey_results(3)");
        $later = array();
        while ($later_averages = mysqli_fetch_array($get_later_averages)) {
            $later[0] = $later_averages['AVG(Question_2)'];
            $later[1] = $later_averages['AVG(Question_3)'];
        ...
        <tr>
<?php
$infile = "downloads/survey_aggregate_individual_pre_post_three_month.csv";
$fp = fopen($infile, "w") or die('can\'t open file');
$title_info = array('Question', 'Pre-Survey', 'Post-Survey', '3 Months Later');
fputcsv($fp, $title_info);
$questions = array(
...
foreach ($question_array as $question) {
    ...
    for ($i = 1; $i < 4; $i++) {
         ...
         * for each pie chart.  
         * This is a different routine than the other pages call, but it's just because the total report
         * shows the responses to the survey from all the participant types who took it.
         */

        $call_for_arrays = "CALL pie_chart_arrays_all_individual(" . $i . ", '" . $question . "')";
        include "../include/dbconnopen.php";
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                var plot1 = $.jqplot('<?php echo $chart_id_array[$chart_counter]; ?>', [[<?php echo $script_str; ?>]], {
                    title: '<?php echo $time_title; ?>',
                    seriesDefaults: {
