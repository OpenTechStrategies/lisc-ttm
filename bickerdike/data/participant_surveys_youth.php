...
?>
<!--This reports on youth surveys. It shows average responses, then includes pie charts for the results.
...
<h3>Youth Participant Surveys -- Aggregate Results</h3>
<p align="center">    
...
<table class="all_projects">
    ...
    $count_pres_sqlsafe ="SELECT * FROM Participant_Survey_Responses WHERE Participant_Type='youth' AND Pre_Post_Late='1'";
    include "../include/dbconnopen.php";
    $pres = mysqli_query($cnnBickerdike, $count_pres_sqlsafe);
    $num_pres = mysqli_num_rows($pres);
    include "../include/dbconnclose.php";
    
    $count_posts_sqlsafe ="SELECT * FROM Participant_Survey_Responses WHERE Participant_Type='youth' AND Pre_Post_Late='2'";
    include "../include/dbconnopen.php";
    $posts = mysqli_query($cnnBickerdike, $count_posts_sqlsafe);
    $num_posts = mysqli_num_rows($posts);
    include "../include/dbconnclose.php";
    
    $count_laters_sqlsafe ="SELECT * FROM Participant_Survey_Responses WHERE Participant_Type='youth' AND Pre_Post_Late='3'";
    include "../include/dbconnopen.php";
...
<!--        <a href="">Reset Aggregates</a>-->
    ...
    <tr>
         <td class="all_projects" style="text-align:left;">Question 8b: Do you agree? I feel comfortable playing outside in my community.</td>
...
$question_array=array('Question_2', 'Question_3', 'Question_4_A', 'Question_4_B', 'Question_5_A',
        'Question_5_B',   'Question_9_A', 'Question_9_B',
   ...
   // foreach ($type_array as $type){
        for ($i=1; $i<4; $i++){
             ...
             */
                ...
                $call_for_arrays_sqlsafe="CALL pie_chart_arrays('youth', " . $i . ", '" .$question_sqlsafe . "')";
...
<div id="chart1_c" class="jqplot-target" style="height: 300px; width: 800px; position: relative;"></div><br/>
</div>
...
<div id="chart2_c" class="jqplot-target" style="height: 300px; width: 800px; position: relative;"></div><br/></div>
...
<a onclick="
	...
	"><h4>How many minutes on those days?</h4></a>
...
<div id="chart8_parent"><div id="chart8" class="jqplot-target" style="height: 300px; width: 800px; position: relative;"></div></div>

<a onclick="
	$('#chart9_parent').slideToggle('slow');
	"><h4>Child Activity in Minutes</h4></a>
<div id="chart9_parent"><div id="chart9" class="jqplot-target" style="height: 300px; width: 800px; position: relative;"></div></div>-->
...
<div id="chart10_c" class="jqplot-target" style="height: 300px; width: 800px; position: relative;"></div><br/></div>

<a onclick="
	$('#chart11_parent').slideToggle('slow');
	"><h4> Do you agree? I feel comfortable playing outside in my community.</h4></a>
