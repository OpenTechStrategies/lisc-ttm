...
<!--This reports on adult surveys. It shows average responses, then includes pie charts for the results.
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#adults_selector').addClass('selected');
		$('#data_selector').addClass('selected');
	});
</script>

<div class="content_wide" id="participant_survey_data">
<h3>Adult Participant Surveys -- Aggregate Results</h3>
<p align="center">
...
<table class="all_projects">
    ...
    $count_pres ="SELECT * FROM Participant_Survey_Responses WHERE Participant_Type='adult' AND Pre_Post_Late='1'";
    include "../include/dbconnopen.php";
    $pres = mysqli_query($cnnBickerdike, $count_pres);
    $num_pres = mysqli_num_rows($pres);
    include "../include/dbconnclose.php";
    
    $count_posts ="SELECT * FROM Participant_Survey_Responses WHERE Participant_Type='adult' AND Pre_Post_Late='2'";
    include "../include/dbconnopen.php";
    $posts = mysqli_query($cnnBickerdike, $count_posts);
    $num_posts = mysqli_num_rows($posts);
    include "../include/dbconnclose.php";
    
    $count_laters ="SELECT * FROM Participant_Survey_Responses WHERE Participant_Type='adult' AND Pre_Post_Late='3'";
    include "../include/dbconnopen.php";
...
<!--        <a href="">Reset Aggregates</a>-->
    ...
    include "../include/dbconnopen.php";
    $get_pre_averages = mysqli_query($cnnBickerdike, "CALL get_aggregate_survey_results('adult', 1)");
    $pre = array();
    ...
    include "../include/dbconnclose.php";
    include "../include/dbconnopen.php";
    $get_post_averages = mysqli_query($cnnBickerdike, "CALL get_aggregate_survey_results('adult', 2)");
    $post = array();
    ...
    include "../include/dbconnopen.php";
    $get_later_averages = mysqli_query($cnnBickerdike, "CALL get_aggregate_survey_results('adult', 3)");
    $later = array();
    ...
    <tr>
         <td class="all_projects" style="text-align:left;">Question 5: Do you have at least one child between the ages of 0-18 that lives with you at least 3 days per week?</td>
...
foreach($question_array as $question){
   ...
   // foreach ($type_array as $type){
        for ($i=1; $i<4; $i++){
             ...
             * for each pie chart.  
             */
                $call_for_arrays="CALL pie_chart_arrays('adult', " . $i . ", '" .$question . "')";
