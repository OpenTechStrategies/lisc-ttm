...
It's recommended that you put together a box yourself that you can
trust, but this process is not easy if done manually (though if you
want to completely do it yourself, [[http://hadooppowered.com/2014/05/10/create-a-debian-wheezy-vagrant-box/][this guide works]]).
