...
function generalized_download($download_name, $permissions, $enlace_session_string, $enlace_program_string){
    $download_list_array=array(
        ...
        'titles' => array("Assessment ID", "Participant ID", "First_Name", "Last_Name", "Program ID", "Program Name",  "Program Site/Org", "DOB", "Age", "Grade", "School", "Home Language", "Ethnicity", "Race", "Recruitment Method", "Youth Behavioral History", "Pre or Post", "Date Logged", "Date Administered"),
        ...
        'add_access' => 1,
        'query2' => ' WHERE Assessments.Pre_Post = 1 ',
        'titles' => array("Assessment ID", "Participant ID", "Program ID", "Program Name",  "Program Site/Org", "DOB", "Age", "Grade", "School", "Home Language", "Ethnicity", "Race", "Recruitment Method", "Youth Behavioral History", "Pre or Post", "Date Logged", "Date Administered"),
