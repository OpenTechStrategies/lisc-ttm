...
'titles' => array("Referral ID", "ID of referred person", "First name of referred person", "Last name of referred person", "Referrer First Name", "Referrer Last Name", "Referring Institution", "Referring Program", "Program referred to", "Date Logged")),
        ...
        'titles' => array("Participant ID", "Session ID", "First Name", "Last Name", "Program ID", "Program Name", "Session Name", "Number of days attended", "Sum of hours for this session", "Dosage percentage for this session", "Total hours across programs and mentorship sessions")),
        ...
        "Sum of hours for this session", "Dosage percentage for this session", "Total hours across programs and mentorship sessions")),
