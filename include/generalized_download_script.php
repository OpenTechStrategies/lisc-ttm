...
'titles' => array("Referral ID", "ID of referred person", "First name of referred person", "Last name of referred person", "Referrer First Name", "Referrer Last Name", "Referring Institution", "Referring Program", "Program referred to", "Date Logged")),
        ...
        'titles' => array("Participant ID", "First Name", "Last Name", "Session ID (of program)", "Session Name",  "Program Name", "Date Entered, Pre Survey", "Date Administered, Pre Survey", "Date Entered, Post Survey", "Date Administered, Post Survey", "Home Language", "Ethnicity", "Race", "Recruitment Method", "Juvenile Justice System History"),
        'legend' => array("(id)", "(name)", "(name)", "(id)", "session", "(program)", "date entered, pre survey", "date administered, pre survey", "date entered, post survey", "date administered, post survey", "0=N/A; 1=Spanish; 2=Other", "0=N/A; 1=Not Hispanic/Latino/Spanish; 2=Yes, Mexican, Mexican-American, Chicago; 3=Yes, Puerto Rican; 4=Yes, Cuban; 5=Yes, Other Hispanic/Latino/Spanish", "0=N/A; 1=White; 2=Black, African-American; 3=American Indian; 4=Asian Indian; 5=Chinese; 6=Filipino; 7=Japanese; 8=Korean; 9=Vietnamese; 10=Other Asian; 11=Native Hawaiian; 12=Guamanian or Chamorro; 13=Samoan; 14=Other Pacific Islander; 15=Some other race", "0=N/A; 1=School Referral; 2=Partner Org Referral; 3=Justice System Referral; 4=In-House Recruitment; 5=Walk-in/Self-Referral", "0=N/A; 1=Has been arrested; 2=Has had minimal interactions; 3=Has received 'station adjustment'; 4=No Interaction; 5=Has received 'citation'; 6=School official interaction (Behavioral Incidents)")), 
        ...
        'query2' => ' WHERE  Pre_Assessments.Pre_Post=1 AND Post_Caring.Caring_Adults_ID IS NOT NULL AND Post_Assessments.Pre_Post=2 AND Pre_Assessments.Date_Logged IN ( SELECT  MAX(Date_Logged) FROM Assessments WHERE Pre_Post =1 GROUP BY Session_ID, Participant_ID) AND  Post_Assessments.Date_Logged IN ( SELECT  MAX(Date_Logged) FROM Assessments WHERE Pre_Post =2 GROUP BY Session_ID, Participant_ID) ',
        'query3' => ' GROUP BY Pre_Assessments.Assessment_ID ',
        'titles' => array("Participant ID", "Session ID (of program)", "Session Name", "Program Name", "Date Entered, Pre Survey", "Date Administered, Pre Survey", "Date Entered, Post Survey", "Date Administered, Post Survey", "Home Language", "Ethnicity", "Race", "Recruitment Method", "Juvenile Justice System History"),
        'legend' => array("(id)", "(id)", "session", "(program)", "date entered, pre survey", "date administered, pre survey", "date entered, post survey", "date administered, post survey", "0=N/A; 1=Spanish; 2=Other", "0=N/A; 1=Not Hispanic/Latino/Spanish; 2=Yes, Mexican, Mexican-American, Chicago; 3=Yes, Puerto Rican; 4=Yes, Cuban; 5=Yes, Other Hispanic/Latino/Spanish", "0=N/A; 1=White; 2=Black, African-American; 3=American Indian; 4=Asian Indian; 5=Chinese; 6=Filipino; 7=Japanese; 8=Korean; 9=Vietnamese; 10=Other Asian; 11=Native Hawaiian; 12=Guamanian or Chamorro; 13=Samoan; 14=Other Pacific Islander; 15=Some other race", "0=N/A; 1=School Referral; 2=Partner Org Referral; 3=Justice System Referral; 4=In-House Recruitment; 5=Walk-in/Self-Referral", "0=N/A; 1=Has been arrested; 2=Has had minimal interactions; 3=Has received 'station adjustment'; 4=No Interaction; 5=Has received 'citation'; 6=School official interaction (Behavioral Incidents)")), 
