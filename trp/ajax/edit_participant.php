...
$get_existing_address_sqlsafe="SELECT Address_Street_Num, Address_Street_Direction, Address_Street_Name, Address_Street_Type, Address_city, 
    Address_State, Address_Zipcode, Block_Group
            FROM Participants
           WHERE Participant_ID='" . mysqli_real_escape_string($_POST['id']) . "'";
...
$DOB_sqlsafe = mysqli_real_escape_string($date_formatted[2]) . "-" . mysqli_real_escape_string($date_formatted[0]) . "-" . mysqli_real_escape_string($date_formatted[1]);

/* save the updated info. */
$edit_participant_query_sqlsafe = "UPDATE Participants SET
                                    First_Name='" . mysqli_real_escape_string($_POST['name']) . "',
                                    Last_Name='" . mysqli_real_escape_string($_POST['surname']) . "',
                                    Address_Street_Name='" . mysqli_real_escape_string($_POST['address_name']) . "',
                                    Address_Street_Num='" . mysqli_real_escape_string($_POST['address_num']) . "',
                                    Address_Street_Direction='" . mysqli_real_escape_string($_POST['address_dir']) . "',
                                    Address_Street_Type='" . mysqli_real_escape_string($_POST['address_type']) . "',
                                    Address_City='" . mysqli_real_escape_string($_POST['city']) . "',
                                    Address_State='" . mysqli_real_escape_string($_POST['state']) . "',
                                    Address_Zipcode= '" . mysqli_real_escape_string($_POST['zip']) . "',
                                        Block_Group='$block_group_sqlsafe',
                                    Phone='" . mysqli_real_escape_string($_POST['phone']) . "',
                                    Email='" . mysqli_real_escape_string($_POST['email']) . "',
                                    Gender='" . mysqli_real_escape_string($_POST['gender']) . "',
                                    DOB='" . $DOB_sqlsafe . "',
									CPS_ID='" . mysqli_real_escape_string($_POST['cps_id']) . "'
                                        WHERE Participant_ID='" . mysqli_real_escape_string($_POST['id']) . "'";
