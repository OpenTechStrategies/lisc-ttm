...
?>
    ...
    foreach ($percent_questions_arr as $question) {
        ...
        $call_for_arrays = "CALL get_count_teacher_surveys_pre_post('" . $question . "')";
    ...
    foreach ($averages_questions_arr as $question) {
        $call_for_arrays = "CALL get_sum_teacher_surveys_pre_post('" . $question . "')";
        ...
        <tr>
            ...
            <td width="50%"><strong>Question 4: </strong>Is your classroom bilingual? <!--show % for each response-->
                <div class="question_summary">
                    Bilingual: <?php echo number_format(($Classroom_Language_arr[1] / $total_responses) * 100) . '%'; ?><br/>
                    Regular:  <?php echo number_format(($Classroom_Language_arr[2] / $total_responses) * 100) . '%'; ?><br/>
                    Other: <?php echo number_format(($Classroom_Language_arr[3] / $total_responses) * 100) . '%'; ?> <br/>
                </div></td>
            <td><strong>Question 5: </strong>How many years have you participated in the Parent Mentor program? <!--show % for each response-->
                <div class="question_summary">
                    First year:  <?php echo number_format(($Years_In_Program_arr[1] / $total_responses) * 100) . '%'; ?><br/>
                    Second year: <?php echo number_format(($Years_In_Program_arr[2] / $total_responses) * 100) . '%'; ?><br/>
                    Third year (or more): <?php echo number_format(($Years_In_Program_arr[3] / $total_responses) * 100) . '%'; ?><br/>
                </div></td>
        </tr>
        <tr>
            <td><strong>Question 6: </strong>Which languages do you speak? <!--show % for each response-->
                <div class="question_summary">
                    English: <?php echo number_format(($Languages_arr[1] / $total_responses) * 100) . '%'; ?><br/>
                    Spanish: <?php echo number_format(($Languages_arr[2] / $total_responses) * 100) . '%'; ?><br/>
                    Other: <?php echo number_format(($Languages_arr[3] / $total_responses) * 100) . '%'; ?><br/>
                    Both English and Spanish: <?php echo number_format(($Languages_arr[4] / $total_responses) * 100) . '%'; ?><br/>
                </div></td>
...
?>
            ...
            <td><strong>Question 9: </strong>How many students do you have in your classroom?
                <div class="question_summary">
                    Average: <?php echo $Num_Students_total / $total_responses; ?><br/>
                    Total: <?php echo $Num_Students_total; ?><br/>
                </div></td>
        </tr>
        <tr>
            <td><strong>Question 10: </strong>How many of your students are ELL?
                <div class="question_summary"><!--grand total and percentage of all students (from q 9 above)-->
                    Total: <?php echo $Num_ELL_Students_total; ?><br/>
                    Percent of total: <?php echo number_format(($Num_ELL_Students_total / $Num_Students_total) * 100) . '%'; ?><br/>
                </div></td>
            <td><strong>Question 11: </strong>How many of your students have IEPs or special needs?
                <div class="question_summary">
                    ...
                    Total: <?php echo $Num_IEP_Students_total; ?><br/>
                    Percent of total: <?php echo number_format(($Num_IEP_Students_total / $Num_Students_total) * 100) . '%'; ?><br/>
                </div></td>
        </tr>
        <tr>
            <td><strong>Question 12: </strong>How many of your students started the year below grade level?
                <div class="question_summary">
                    <!--grand total and percentage of all students (from q 9 above)-->
                    Total: <?php echo $Num_Students_Below_Grade_Level_total; ?><br/>
                    Percent of total: <?php echo number_format(($Num_Students_Below_Grade_Level_total / $Num_Students_total) * 100) . '%'; ?><br/>
                </div></td>
            <td></td>
        </tr>
    </table>
...
foreach ($percent_questions_arr as $question) {
    $call_for_arrays = "CALL get_count_teacher_pre_post_surveys('" . $question . "')";
    // echo $call_for_arrays;
    include "../include/dbconnopen.php";
    $questions = mysqli_query($cnnLSNA, $call_for_arrays);
    $num_options = mysqli_num_rows($questions);
...
?>
    ...
    <table>
        <tr>
            <td width="50%"><strong>Question 5: </strong>My Parent Mentor... <!--show % for each category-->
                <div class="question_summary">
                    never missed a day  of work: <?php echo number_format(($Attendance_arr[5] / $total_post_responses) * 100) . '%'; ?><br>
                    missed occasionally but always found a way to communicate with me: <?php echo number_format(($Attendance_arr[4] / $total_post_responses) * 100) . '%'; ?><br>
                    missed occasionally without notice or explanation: <?php echo number_format(($Attendance_arr[3] / $total_post_responses) * 100) . '%'; ?><br>
                    had irregular attendance and made it difficult for me to count on him or her: <?php echo number_format(($Attendance_arr[2] / $total_post_responses) * 100) . '%'; ?><br>
                    left mid-semester without notice and I have not heard from her/him since: <?php echo number_format(($Attendance_arr[1] / $total_post_responses) * 100) . '%'; ?><br>
            ...
            <td><strong>Question 8: </strong>Having the support of a Parent Mentor helps me achieve or maintain good classroom management. <!--show % for each response-->
                <div class="question_summary">
                    Strongly Agree: <?php echo number_format(($Classroom_Benefits_8_arr[5] / $total_post_responses) * 100) . '%'; ?><br>
                    Agree:  <?php echo number_format(($Classroom_Benefits_8_arr[4] / $total_post_responses) * 100) . '%'; ?><br>
                    Neutral:  <?php echo number_format(($Classroom_Benefits_8_arr[3] / $total_post_responses) * 100) . '%'; ?><br>
                    Disagree:  <?php echo number_format(($Classroom_Benefits_8_arr[2] / $total_post_responses) * 100) . '%'; ?><br>
                    Strongly Disagree:  <?php echo number_format(($Classroom_Benefits_8_arr[1] / $total_post_responses) * 100) . '%'; ?><br>
                    N/A:  <?php echo number_format(($Classroom_Benefits_8_arr[0] / $total_post_responses) * 100) . '%'; ?><br>
                </div></td>
        </tr>
        <tr>
            <td><strong>Question 9: </strong>Having the support of a Parent Mentor helps me improve homework completion and helps me maintain a high expectatin for homework in my classroom. <!--show % for each response-->
                <div class="question_summary">
                    Strongly Agree: <?php echo number_format(($Classroom_Benefits_9_arr[5] / $total_post_responses) * 100) . '%'; ?><br>
                    Agree:  <?php echo number_format(($Classroom_Benefits_9_arr[4] / $total_post_responses) * 100) . '%'; ?><br>
                    Neutral:  <?php echo number_format(($Classroom_Benefits_9_arr[3] / $total_post_responses) * 100) . '%'; ?><br>
                    Disagree:  <?php echo number_format(($Classroom_Benefits_9_arr[2] / $total_post_responses) * 100) . '%'; ?><br>
                    Strongly Disagree:  <?php echo number_format(($Classroom_Benefits_9_arr[1] / $total_post_responses) * 100) . '%'; ?><br>
                    N/A:  <?php echo number_format(($Classroom_Benefits_9_arr[0] / $total_post_responses) * 100) . '%'; ?><br>
                </div></td>
            <td><strong>Question 10: </strong>Having the support of a Parent Mentor helps me improve students in reading and/or math. <!--show % for each response-->
                <div class="question_summary">
                    Strongly Agree: <?php echo number_format(($Classroom_Benefits_10_arr[5] / $total_post_responses) * 100) . '%'; ?><br>
                    Agree:  <?php echo number_format(($Classroom_Benefits_10_arr[4] / $total_post_responses) * 100) . '%'; ?><br>
                    Neutral:  <?php echo number_format(($Classroom_Benefits_10_arr[3] / $total_post_responses) * 100) . '%'; ?><br>
                    Disagree:  <?php echo number_format(($Classroom_Benefits_10_arr[2] / $total_post_responses) * 100) . '%'; ?><br>
                    Strongly Disagree:  <?php echo number_format(($Classroom_Benefits_10_arr[1] / $total_post_responses) * 100) . '%'; ?><br>
                    N/A:  <?php echo number_format(($Classroom_Benefits_10_arr[0] / $total_post_responses) * 100) . '%'; ?><br>
                </div></td>
        </tr>
        <tr>
            <td><strong>Question 11: </strong>Having a Parent Mentor strengthens my understanding of or connection to the community. <!--show % for each response-->
                <div class="question_summary">
                    Strongly Agree: <?php echo number_format(($Classroom_Benefits_11_arr[5] / $total_post_responses) * 100) . '%'; ?><br>
                    Agree:  <?php echo number_format(($Classroom_Benefits_11_arr[4] / $total_post_responses) * 100) . '%'; ?><br>
                    Neutral:  <?php echo number_format(($Classroom_Benefits_11_arr[3] / $total_post_responses) * 100) . '%'; ?><br>
                    Disagree:  <?php echo number_format(($Classroom_Benefits_11_arr[2] / $total_post_responses) * 100) . '%'; ?><br>
                    Strongly Disagree:  <?php echo number_format(($Classroom_Benefits_11_arr[1] / $total_post_responses) * 100) . '%'; ?><br>
                    N/A:  <?php echo number_format(($Classroom_Benefits_11_arr[0] / $total_post_responses) * 100) . '%'; ?><br>
                </div></td>
            <td><strong>Question 12: </strong>Having a Parent Mentor strengthens student social-emotional development. <!--show % for each response-->
                <div class="question_summary">
                    Strongly Agree: <?php echo number_format(($Classroom_Benefits_12_arr[5] / $total_post_responses) * 100) . '%'; ?><br>
                    Agree:  <?php echo number_format(($Classroom_Benefits_12_arr[4] / $total_post_responses) * 100) . '%'; ?><br>
                    Neutral:  <?php echo number_format(($Classroom_Benefits_12_arr[3] / $total_post_responses) * 100) . '%'; ?><br>
                    Disagree:  <?php echo number_format(($Classroom_Benefits_12_arr[2] / $total_post_responses) * 100) . '%'; ?><br>
                    Strongly Disagree:  <?php echo number_format(($Classroom_Benefits_12_arr[1] / $total_post_responses) * 100) . '%'; ?><br>
                    N/A:  <?php echo number_format(($Classroom_Benefits_12_arr[0] / $total_post_responses) * 100) . '%'; ?><br>
                </div></td>
        </tr>
        <tr>
            <td><strong>Question 13: </strong>The Parent Mentor Program helps our school create a welcoming and communicative environment for all parents. <!--show % for each response-->
                <div class="question_summary">
                    Strongly Agree: <?php echo number_format(($School_Benefits_13_arr[5] / $total_post_responses) * 100) . '%'; ?><br>
                    Agree:  <?php echo number_format(($School_Benefits_13_arr[4] / $total_post_responses) * 100) . '%'; ?><br>
                    Neutral:  <?php echo number_format(($School_Benefits_13_arr[3] / $total_post_responses) * 100) . '%'; ?><br>
                    Disagree:  <?php echo number_format(($School_Benefits_13_arr[2] / $total_post_responses) * 100) . '%'; ?><br>
                    Strongly Disagree:  <?php echo number_format(($School_Benefits_13_arr[1] / $total_post_responses) * 100) . '%'; ?><br>
                    N/A:  <?php echo number_format(($School_Benefits_13_arr[0] / $total_post_responses) * 100) . '%'; ?><br>
                </div></td>
            <td><strong>Question 14: </strong>The Parent Mentor Program helps our school build parent-teacher trust. <!--show % for each response-->
                <div class="question_summary">
                    Strongly Agree: <?php echo number_format(($School_Benefits_14_arr[5] / $total_post_responses) * 100) . '%'; ?><br>
                    Agree:  <?php echo number_format(($School_Benefits_14_arr[4] / $total_post_responses) * 100) . '%'; ?><br>
                    Neutral:  <?php echo number_format(($School_Benefits_14_arr[3] / $total_post_responses) * 100) . '%'; ?><br>
                    Disagree:  <?php echo number_format(($School_Benefits_14_arr[2] / $total_post_responses) * 100) . '%'; ?><br>
                    Strongly Disagree:  <?php echo number_format(($School_Benefits_14_arr[1] / $total_post_responses) * 100) . '%'; ?><br>
                    N/A:  <?php echo number_format(($School_Benefits_14_arr[0] / $total_post_responses) * 100) . '%'; ?><br>
                </div></td>
        </tr>
        <tr>
            <td><strong>Question 15: </strong>The Parent Mentor Program helps teachers and parents to think of each other as partners in educating. <!--show % for each response-->
                <div class="question_summary">
                    Strongly Agree: <?php echo number_format(($School_Benefits_15_arr[5] / $total_post_responses) * 100) . '%'; ?><br>
                    Agree:  <?php echo number_format(($School_Benefits_15_arr[4] / $total_post_responses) * 100) . '%'; ?><br>
                    Neutral:  <?php echo number_format(($School_Benefits_15_arr[3] / $total_post_responses) * 100) . '%'; ?><br>
                    Disagree:  <?php echo number_format(($School_Benefits_15_arr[2] / $total_post_responses) * 100) . '%'; ?><br>
                    Strongly Disagree:  <?php echo number_format(($School_Benefits_15_arr[1] / $total_post_responses) * 100) . '%'; ?><br>
                    N/A:  <?php echo number_format(($School_Benefits_15_arr[0] / $total_post_responses) * 100) . '%'; ?><br>
                </div></td>
            <td></td>
        </tr>
    </table>
    ...
    <table class="inner_table" style="font-size:.8em;margin-left:auto;margin-right:auto;width:60%;">
        ...
        <tr>
            <td>grade papers:</td>
            <td style="text-align:center;"><?php echo number_format(($Task_1_num / $total_responses) * 100) . '%'; ?></td>
            <td style="text-align:center;"><?php echo number_format(($Task_1_post_num / $total_responses) * 100) . '%'; ?></td>
        </tr>
        <tr>
            <td>tutor students one on one:</td>
            <td style="text-align:center;"><?php echo number_format(($Task_2_num / $total_responses) * 100) . '%'; ?></td>
            <td style="text-align:center;"><?php echo number_format(($Task_2_post_num / $total_responses) * 100) . '%'; ?></td>
        </tr>
        <tr>
            <td>lead part of the class in an activity:</td>
            <td style="text-align:center;"><?php echo number_format(($Task_3_num / $total_responses) * 100) . '%'; ?></td>
            <td style="text-align:center;"><?php echo number_format(($Task_3_post_num / $total_responses) * 100) . '%'; ?></td>
        </tr>
        <tr>
            <td>take children to the washroom, etc:</td>
            <td style="text-align:center;"><?php echo number_format(($Task_4_num / $total_responses) * 100) . '%'; ?></td>
            <td style="text-align:center;"><?php echo number_format(($Task_4_post_num / $total_responses) * 100) . '%'; ?></td>
        </tr>
        <tr>
            <td>help with discipline/disruptions:</td>
            <td style="text-align:center;"><?php echo number_format(($Task_5_num / $total_responses) * 100) . '%'; ?></td>
            <td style="text-align:center;"><?php echo number_format(($Task_5_post_num / $total_responses) * 100) . '%'; ?></td>
        </tr>
        <tr>
            <td>check homework:</td>
            <td style="text-align:center;"><?php echo number_format(($Task_6_num / $total_responses) * 100) . '%'; ?></td>
            <td style="text-align:center;"><?php echo number_format(($Task_6_post_num / $total_responses) * 100) . '%'; ?></td>
        </tr>
        <tr>
            <td>work with small groups of students:</td>
            <td style="text-align:center;"><?php echo number_format(($Task_7_num / $total_responses) * 100) . '%'; ?></td>
            <td style="text-align:center;"><?php echo number_format(($Task_7_post_num / $total_responses) * 100) . '%'; ?></td>
        </tr>
        <tr>
            <td>lead the whole class in an activity:</td>
            <td style="text-align:center;"><?php echo number_format(($Task_8_num / $total_responses) * 100) . '%'; ?></td>
            <td style="text-align:center;"><?php echo number_format(($Task_8_post_num / $total_responses) * 100) . '%'; ?></td>
        </tr>
        <tr>
        ...
        <tr>
            <td>other:</td>
            <td style="text-align:center;"><?php echo number_format(($Task_10_num / $total_responses) * 100) . '%'; ?></td>
            <td style="text-align:center;"><?php echo number_format(($Task_10_post_num / $total_responses) * 100) . '%'; ?></td>
        </tr>
    </table>
...
foreach ($question_array as $question) {
    ...
    if ($question_count == 0) {
        ?><tr>
                        ...
                        ?><tr>
                            <td class="all_projects"  style="text-align:left;width:200px"><?php echo $text_array[$question_count]; ?></td><?php
                        ...
                        ORDER BY Teacher_Involvement_A LIMIT " . floor($total_responses / 2) . ", 1;";
                            ...
                            // echo $script_str;
                            if ($i == 1) {
                                echo "<br>mean: " . number_format($pre[$question_count], 2);
                            }
                            if ($i == 2) {
